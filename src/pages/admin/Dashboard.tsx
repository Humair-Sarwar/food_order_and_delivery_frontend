        ...
        <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-xs font-semibold text-gray-500 mt-0.5">
              Real-time platform logs, analytical insights, and operational
              metrics.
            </p>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="mt-4 flex items-end justify-between">
                  ...
                  <div
                    className={`flex items-center gap-0.5 px-2 py-0.5 rounded-lg text-[10px] font-black border ${
                      stat.isPositive
        ...
        <div className="grid gap-6 lg:grid-cols-3">
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
              <div>
                ...
                <p className="text-[11px] font-bold text-gray-400 mt-0.5">
                  Incoming user culinary routing queues.
                </p>
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4">
                          <div
                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold border ${order.statusClass}`}
                          >
          ...
          <div className="bg-white border border-gray-200/80 rounded-2xl shadow-sm overflow-hidden flex flex-col">
            <div className="px-6 py-5 border-b border-gray-100">
              ...
              <p className="text-[11px] font-bold text-gray-400 mt-0.5">
                Highest order conversions this cycle.
              </p>
            </div>
